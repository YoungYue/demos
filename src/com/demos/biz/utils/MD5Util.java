...
public class MD5Util {
	...
	public static void main(String[] args) throws IOException {
		File file = new File("C:\\Documents and Settings\\Yang.YYANG\\桌面\\磁器口\\05052013(001).jpg");
		...
		System.out.println("md5:" + getFileMD5String(file));
		System.out.println("md5:" + getFileMD5String(file));
		System.out.println("md5:" + getFileMD5String("C:\\Documents and Settings\\Yang.YYANG\\桌面\\磁器口\\", "05052013.jpg"));
	}

	public static String getFileMD5String(String filePath, String fileName) throws IOException {
		return getFileMD5String(new File(filePath + fileName));
	}
